...
// FIX: Export TerminalIcon to be used in DeploymentGuidesView.tsx
...
export const FlaskIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M10.125 2.25A1.875 1.875 0 0112 4.125V15.75c0 .721-.572 1.304-1.288 1.396-1.42.177-2.812-.346-3.858-1.34-1.04-.993-1.636-2.311-1.748-3.72a.75.75 0 01.354-.783c.075-.054.162-.089.26-.104M10.125 2.25A1.875 1.875 0 008.25 4.125V15.75c0 .721.572 1.304 1.288 1.396 1.42.177 2.812-.346 3.858-1.34 1.04-.993 1.636-2.311 1.748-3.72a.75.75 0 00-.354-.783c-.075-.054-.162-.089-.26-.104M8.25 10.5h7.5" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 5.25l-2.625 2.625m-3.75-2.25L10.5 4.5m4.5 10.5h-9" />
  </svg>
);
...
export const ICON_LIBRARY: Record<CustomizableAction, Record<string, React.FC<IconProps>>> & { settings: Record<string, React.FC<IconProps>> } = {
  ...
  generateTests: { // New icon for test generation
    'Flask': FlaskIcon,
  },
  settings: {
    'Gear': GearIcon,
...
export const DEFAULT_ICONS: Record<CustomizableAction, string> = {
    ...
    insertSnippet: 'CodeBracketSquare',
    generateTests: 'Flask', // Default icon for generate tests
};